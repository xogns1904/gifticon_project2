...
public class gift_giving2_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gift_go.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(gift_giving2_Activity.this,
                        kr.co.company.gifticon_project.gift_clear2.class);
